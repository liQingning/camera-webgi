...
function setupViewer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        //加载资源管理器
        const manager = yield viewer.addPlugin(AssetManagerPlugin);
        ...
        // 添加webgi插件
        yield addBasePlugins(viewer);
        yield viewer.addPlugin(FileTransferPlugin);
        yield viewer.addPlugin(CanvasSnipperPlugin);
        ...
        function setupScrollAnimation() {
            ...
            const smootherBG = window.ScrollSmoother.create({
            ...
            const clickbutton = document.querySelector('.button button-know-more');
            // 第一部分到第二部分
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    ...
                    position.set(lerp(3.51, 1.59, p), lerp(0.618, -0.42, p), lerp(10.14, -8.369, p));
                    target.set(lerp(-1.588, -1.58, p), lerp(0.012, 0.012, p), lerp(0.5, 0.49, p));
                    const textEl = document.querySelector('.hero--content');
                    if (textEl) {
                        textEl.style.opacity = `${lerp(1, 0, p * 3)}`;
                        textEl.style.transform = `translateX(${-p * 400}px) translateY(${p * window.innerHeight}px)`;
                    }
                    const textE2 = document.querySelector('.hero--scroller--container');
                    if (textE2) {
                        textE2.style.opacity = `${lerp(1, 0, p)}`;
                        textE2.style.transform = `translateY(${p * window.innerHeight * 1.5}px)`;
                    }
                    const textE3 = document.querySelector('.video--content');
                    if (textE3) {
            ...
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    ...
                    position.set(lerp(1.59, -0.16, p), lerp(-0.42, -0.41, p), lerp(-8.369, -8.38, p));
                    target.set(lerp(-1.58, 0.03, p), lerp(0.012, 0.037, p), lerp(0.49, 1, p));
                    const textEl = document.querySelector('.view2');
                    if (textEl) {
                        textEl.style.opacity = `${lerp(1, 0, p)}`;
                    }
                    const textE2 = document.querySelector('.view3');
                    if (textE2) {
                        textE2.style.opacity = `${lerp(0, 1, p)}`;
                    }
                    const textE3 = document.querySelector('.design--content1');
                    if (textE3) {
                        textE3.style.opacity = `${lerp(0, 1, p)}`;
                        textE3.style.transform = `translateX(${p * 400}px) `;
                    }
                    const textE4 = document.querySelector('.video--content');
                    if (textE4) {
                        textE4.style.opacity = `${lerp(1, 0, p)}`;
                    }
                    const textE5 = document.querySelector('.design--container2');
                    if (textE5) {
                        textE5.style.opacity = `${lerp(0, 1, p)}`;
            ...
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    ...
                    position.set(lerp(-0.16, -0.826, p), lerp(-0.41, -4.11, p), lerp(-8.38, -1.57, p));
                    target.set(lerp(0.03, -0.83, p), lerp(0.037, 0.886, p), lerp(1, -0.018, p));
                    const textE1 = document.querySelector('.view3');
                    if (textE1) {
                        textE1.style.opacity = `${lerp(1, 0, p)}`;
                    }
                    const textE2 = document.querySelector('.design--content1');
                    if (textE2) {
                        textE2.style.opacity = `${lerp(1, 0, p)}`;
                        textE2.style.transform = `translateX(${p * 400 + 400}px) `;
                    }
                    const textE3 = document.querySelector('.design--container2');
                    if (textE3) {
                        textE3.style.opacity = `${lerp(1, 0, p)}`;
                        textE3.style.transform = `translateX(${-p * 400 - 400}px) `;
                    }
                    const textE4 = document.querySelector('.view4--content1');
                    if (textE4) {
                        textE4.style.opacity = `${lerp(0, 1, (p - 0.5) * 2)}`;
                    }
                    const textE5 = document.querySelector('.view4--line');
                    if (textE5) {
            ...
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    ...
                    const textE4 = document.querySelector('.view4--line');
                    if (textE4) {
            ...
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    const p = self.progress;
                    const textE1 = document.querySelector('.view5--content1');
                    if (textE1) {
                        textE1.style.opacity = `${lerp(1, 0, p * 2)}`;
                        textE1.style.transform = `translateY(${p * window.innerHeight}px)`;
                    }
                    const textE2 = document.querySelector('.view5--line');
                    if (textE2) {
                    ...
                    const textE3 = document.querySelector('.view6--line');
                    if (textE3) {
                        textE3.style.opacity = `${lerp(0, 1, p)}`;
                        const height = lerp(0, 270, p);
                        textE3.style.height = `${height}px`;
                    ...
                    const textE4 = document.querySelector('.view6--content1');
                    if (textE4) {
            ...
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    ...
                    position.set(lerp(-0.826, -0.36, p), lerp(-4.11, -1.227, p), lerp(-1.57, -0.215, p));
                    target.set(lerp(-0.83, -0.357, p), lerp(0.886, 0.89, p), lerp(-0.018, -0.04, p));
                    const textE1 = document.querySelector('.view6--content1');
                    if (textE1) {
                        textE1.style.opacity = `${lerp(1, 0, p * 2)}`;
                        textE1.style.transform = `translateY(${p * window.innerHeight}px)`;
                    }
                    const textE2 = document.querySelector('.view6--line');
                    if (textE2) {
                        textE2.style.opacity = `${lerp(1, 0, p * 2)}`;
                        const height = lerp(270, 0, p * 2);
                        textE2.style.height = `${height}px`;
                    ...
                    const textE3 = document.querySelector('.view7');
                    if (textE3) {
                        textE3.style.opacity = `${lerp(0, 1, p)}`;
                    }
                    const textE4 = document.querySelector('.view7--container1');
                    if (textE4) {
                        textE4.style.opacity = `${lerp(0, 1, p)}`;
            ...
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    ...
                    position.set(lerp(-0.36, 0.0, p), lerp(-1.227, -2.39, p), lerp(-0.215, -1.8, p));
                    target.set(lerp(-0.357, 0.0, p), lerp(0.89, 0.677, p), lerp(-0.04, -0.38, p));
                    const textE1 = document.querySelector('.view7');
                    if (textE1) {
                        textE1.style.opacity = `${lerp(1, 0, p)}`;
                    }
                    const textE2 = document.querySelector('.view7--container1');
                    if (textE2) {
                        textE2.style.opacity = `${lerp(1, 0, p)}`;
                        textE2.style.transform = ` translateX(${-p * 400 + 400}px) translateY(${p * window.innerHeight}px)`;
                    }
                    const textE3 = document.querySelector('.view8');
                    if (textE3) {
                        textE3.style.opacity = `${lerp(0, 1, p)}`;
                        if (p == 1) {
                    ...
                    const textE4 = document.querySelector('.view8--container1');
                    if (textE4) {
                        textE4.style.opacity = `${lerp(0, 1, p)}`;
                        textE4.style.transform = `translateY(${p * 400 + (p - 1) * window.innerHeight}px)`;
                    }
                    const textE5 = document.querySelector('.view8--content2');
                    if (textE5) {
                        if (p <= 0.9) {
            ...
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    ...
                    const gray = Math.round(lerp(239, 0, p));
                    document.body.style.backgroundColor = `rgb(${gray}, ${gray}, ${gray})`; //背景变黑
                    position.set(lerp(0.0, 2.64, p), lerp(-2.39, -0.9, p), lerp(-1.8, 0.1, p));
                    target.set(lerp(0.0, -1.8, p), lerp(0.677, -0.9, p), lerp(-0.38, -0.9, p));
                    const textE1 = document.querySelector('.view8');
                    if (textE1) {
                        textE1.style.opacity = `${lerp(1, 0, p)}`;
                    }
                    const textE2 = document.querySelector('.view8--container1');
                    if (textE2) {
                        textE2.style.opacity = '1';
                        textE2.style.opacity = `${lerp(1, 0, p)}`;
                    }
                    const textE3 = document.querySelector('.view8--content2');
                    if (textE3) {
                        textE3.style.opacity = `${lerp(1, 0, p)}`;
                    }
                    const textE4 = document.querySelector('.view9--container1');
                    if (textE4) {
                        textE4.style.opacity = `${lerp(0, 1, p)}`;
                        textE4.style.transform = `translateX(${-p * 400}px) translateY(${(p - 1) * window.innerHeight}px)`;
                    }
                    const textE5 = document.querySelector('.view9');
                    if (textE5) {
                        textE5.style.opacity = `${lerp(0, 1, p)}`;
                    }
                    onUpdate();
            ...
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    ...
                    position.set(lerp(2.64, 2.39, p), lerp(-0.9, 0.226, p), lerp(0.1, 9, p));
                    target.set(lerp(-1.8, -1.5, p), lerp(-0.9, 0.0337, p), lerp(-0.9, 0.45, p));
                    const textE1 = document.querySelector('.view9');
                    if (textE1) {
                        textE1.style.opacity = `${lerp(1, 0, p)}`;
                    }
                    const textE2 = document.querySelector('.view9--container1');
                    if (textE2) {
                        textE2.style.opacity = `${lerp(1, 0, p)}`;
                        textE2.style.transform = `translateX(${p * 800 - 400}px) translateY(${p * window.innerHeight}px)`;
                    }
                    const textE3 = document.querySelector('.view10');
                    if (textE3) {
                        textE3.style.opacity = `${lerp(0, 1, p)}`;
                    }
                    const textE4 = document.querySelector('.view10--container1');
                    if (textE4) {
                        textE4.style.opacity = `${lerp(0, 1, p)}`;
                        textE4.style.transform = `translateX(${p * 400}px) translateY(${(p - 1) * window.innerHeight}px)`;
                    }
                    const textE5 = document.querySelector('.view10--container2 h1');
                    if (textE5) {
                    ...
                    const textE6 = document.querySelector('.view10--content1');
                    if (textE6) {
                    ...
                    const textE7 = document.querySelector('.view10--content2');
                    if (textE7) {
                    ...
                    const textE8 = document.querySelector('.view10--content3');
                    if (textE8) {
            ...
            ScrollTrigger.create({
                ...
                onUpdate: self => {
                    const p = self.progress;
                    position.set(lerp(2.39, 1.61, p), lerp(0.226, -0.09, p), lerp(9, -8.37, p));
                    target.set(lerp(-1.5, -1.588, p), lerp(0.0337, 0.012, p), lerp(0.45, 0.5, p));
                    const textE1 = document.querySelector('.view11--container1');
                    if (textE1) {
                    ...
                    const textE2 = document.querySelector('.view11');
                    if (textE2) {
                        textE2.style.opacity = `${lerp(0, 1, p)}`;
                    }
                    const textE3 = document.querySelector('.view10');
    ...
    html, body {
      scroll-snap-type: y mandatory;
        ...
        // 了解更多
        (_a = document.querySelector('.button-know-more')) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => {
            const element = document.querySelector('.cam-view-2');
            window.scrollTo({ top: element === null || element === void 0 ? void 0 : element.getBoundingClientRect().top, left: 0, behavior: 'smooth' });
        });
        //滚动吸附
        function setupCustomWheelSmoothScrolling(viewer, element, snapPositions, speed = 1.5) {
